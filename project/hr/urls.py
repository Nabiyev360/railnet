...
from .views import hr_misconducts_view, misconduct_detail_view, misconduct_protocol_behest_view
...
urlpatterns = [
    ...
    path('misconduct/send-director/<int:pk>', misconduct_protocol_behest_view, name='misconduct_send_director'),
]
